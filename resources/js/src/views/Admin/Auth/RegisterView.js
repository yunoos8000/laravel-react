...
export default function RegisterView() {
    ...
    const authResponse = useSelector(state=>state.adminAuth.adminAuthResponse)
    const formErr = useSelector(state=>state.adminAuth.form_error)
      ...
      <div className="row mx-0 bg-earth-op">
        <div className="hero-static col-md-6 col-xl-8 d-none d-md-flex align-items-md-end">
          <div className="p-30 invisible" data-toggle="appear">
            ...
            <p className="font-size-h5 text-white">
              <i className="fa fa-angles-right" /> Create Admin account .
            </p>
        ...
        <div className="hero-static col-md-6 col-xl-4 d-flex align-items-center bg-white">
          <div className="content content-full">
            ...
            <form className="js-validation-signup px-30" onSubmit={(e)=>adminRegister(e)} method="post">
                <div className={"form-group row " + (formErr.name ? 'is-invalid' : '') }>
                    <div className="col-12">
                        <div className="form-material floating">
                            ...
                            <label htmlFor="signup-adminname">Admin Name</label>
                        </div>
                ...
                <div className="form-group">
                    ...
                    <Link className="link-effect text-muted mr-10 mb-5 d-inline-block" to="/admin/login">
